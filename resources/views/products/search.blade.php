...
<x-app-layout>
                    ...
                    <div class="category-carousel swiper">
                        <div class="swiper-wrapper">
                            @foreach ($categories as $category)
                                <img src="{{ asset('images/' . $category->url) }}" class="rounded-circle"
                                    alt="{{ $category->name }}">
    ...
    <section class="py-5 pb-5 overflow-hidden mt-5">
        @if (session('success'))
                                        ...
                                        <div class="product-item">
                                            <figure>
                                                <a href="{{ route('product.show', $product->id) }}"
                                                    title="{{ $product->name }}">
                                                    <img src="{{ asset('Image/' . $product->url) }}"
                                                        alt="{{ $product->name }}"
                                                        class="tab-image rounded-circle img-fluid">
                                                </a>
                                            </figure>
