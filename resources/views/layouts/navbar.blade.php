...
<nav class="navbar navbar-expand-lg navbar-light bg-light  d-lg-block fixed-top shadow ">
    <div class="container-fluid ">
      ...
      <div class="collapse navbar-collapse ml-auto" id="navbarToggleExternalContent" >
        <ul class=" navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link " href="{{ url('/carts') }}" tabindex="-1" aria-disabled="true">Cart</a>
          </li>
              <li class="nav-item">
